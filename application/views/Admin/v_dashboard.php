          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Pestisida</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Kategori Product Pestisida</h6>
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Pupuk</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Kategori Product Pupuk</h6>
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Alat Pertanian</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Kategori Product Alat Pertanian</h6>
